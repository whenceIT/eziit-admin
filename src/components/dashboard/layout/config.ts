...
export const adminNavItems: NavItemConfig[] = [
  ...
  { key: 'clients', title: 'Clients', href: paths.dashboard.clients.index, icon: 'users', 
    items: [{ key: "employers", title: "Linked Employers", href: paths.dashboard.clients.employers, },
            { key: "merchants", title: "Linked Merchants", href: paths.dashboard.clients.merchants, },
            //{ key: "notLinked", title: "UnLinked", href: paths.dashboard.clients.notLinked, },
            { key: "underwriters", title: "Linked Underwriters", href: paths.dashboard.clients.underwriters, }, ]},
  { key: 'employers', title: 'Employers', href: paths.dashboard.employers.index, icon: 'employers',
    items: [{ key: "clients", title: "Linked Clients", href: paths.dashboard.employers.clients, },
      { key: "merchants", title: "Linked Merchants", href: paths.dashboard.employers.merchants, },
      //{ key: "notLinked", title: "UnLinked", href: paths.dashboard.clients.notLinked, },
      { key: "underwriters", title: "Linked Underwriters", href: paths.dashboard.employers.underwriters, }, ]},

  { key: 'merchants', title: 'Merchants', href: paths.dashboard.merchants.index, icon: 'users',
    items: [{ key: "clients", title: "Linked Clients", href: paths.dashboard.merchants.clients, }, 
            { key: "employers", title: "Linked Employers", href: paths.dashboard.merchants.employers, },
            { key: "underwriters", title: "Linked Underwriters", href: paths.dashboard.merchants.underwriters, },   
    ]},
  { key: 'underwriters', title: 'Underwriters', href: paths.dashboard.underwriters.index, icon: 'employers',
    items: [{ key: "clients", title: "Linked Clients", href: paths.dashboard.underwriters.clients, },
            { key: "employers", title: "Linked Employers", href: paths.dashboard.underwriters.employers, },
            { key: "merchants", title: "Linked Merchants", href: paths.dashboard.underwriters.merchants, },
    ]
  },
