...
export default function OrganizationsReport() {
  ...
  const fetchTransactions = async () => {
    ...
    const response = await fetch(
      `https://ezitt.whencefinancesystem.com/transactions?start_date=${startDate}&end_date=${endDate}&user_type=underwriter`,
    )
    if (response.ok) {
